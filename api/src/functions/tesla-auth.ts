...
export async function startAuth(req: HttpRequest, ctx: InvocationContext): Promise<HttpResponseInit> {
...
export async function callback(req: HttpRequest, ctx: InvocationContext): Promise<HttpResponseInit> {
